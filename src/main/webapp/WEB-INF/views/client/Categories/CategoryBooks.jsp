										    ...
										    <ul class="pagination">
										        ...
										        <c:choose>
										            <c:when test="${currentPage > 1}">
										                <li class="page-item">
										                    <a class="page-link" href="categories/${danhMuc.id}.htm?page=${currentPage - 1}" aria-label="Previous">
										        ...
										        <c:forEach var="page" begin="1" end="${totalPages}">
										            <li class="page-item ${page == currentPage ? 'active' : ''}">
										                <a class="page-link" href="categories/${danhMuc.id}.htm?page=${page}">${page}</a>
										            </li>
										        </c:forEach>
										        ...
										        <c:choose>
										            <c:when test="${currentPage < totalPages}">
										                <li class="page-item">
										                    <a class="page-link" href="categories/${danhMuc.id}.htm?page=${currentPage + 1}" aria-label="Next">
