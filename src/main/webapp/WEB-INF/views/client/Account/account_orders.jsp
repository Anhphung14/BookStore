            ...
            <div class="author-card pb-3">
                ...
                <div class="author-card-profile">
                    ...
                    <div class="author-card-details">
						<h5 class="author-card-name text-lg">${user.fullname}</h5><span class="author-card-position">Joined ${user.created_at}</span>                    </div>
                </div>
            </div>
            <div class="wizard">
            ...
            <td>
				...
				<c:if test="${order.status == 1}">
					...
					<c:forEach var="reviewedOrderId" items="${order_reviewed}">
					    <c:if test="${reviewedOrderId.toString() eq order.id.toString()}">
					...
					<c:if test="${!isReviewed}">
					    <a class="btn btn-success btn-sm" href="${pageContext.servletContext.contextPath}/account/ratings/${order.id}.htm">Review</a>
					</c:if>
			    </c:if>
            </td>
        </tr>
